...
function __init__()
    ...
    @require DataFrames="a93c6f00-e57d-5684-b7b6-d8193f3e46c0" include("PredictUtils.jl")
    @require GLMakie="e9467ef8-e4e7-5192-8a1a-b1aee30e663a" begin
        @require VideoIO="d6d074c3-1acf-5d4c-9a43-ef38773959a2" include("WebCamUtils.jl")
    end
